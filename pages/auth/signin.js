...
export default function SignIn({ providers }) {
  ...
  return (
    <>
      ...
      <div className="min-h-full flex flex-col justify-center py-12 mt-12 sm:px-6 lg:px-8">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-16 px-4  sm:rounded-lg sm:px-10">
            <div>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
          ...
          <p className="text-base font-regular text-gray-500">
            Ask your Dabble Lab project maintainer
          </p>
        </div>
      </div>
    </>
